...
namespace MasterDetailsCRUDAPP {
    ...
    public partial class TraineeDBDataSet1 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/TraineeDBDataSet11.xsd";
        ...
        public partial class CourseDataTable : global::System.Data.TypedTableBase<CourseRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CourseRow AddCourseRow(int CourseID, string Course, int CourseFee) {
...
namespace MasterDetailsCRUDAPP.TraineeDBDataSet1TableAdapters {
    ...
    public partial class CourseTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Course] ([CourseID], [Course], [CourseFee]) VALUES (@CourseID," +
                " @Course, @CourseFee);\r\nSELECT CourseID, Course, CourseFee FROM Course WHERE (Co" +
                "urseID = @CourseID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Course] SET [CourseID] = @CourseID, [Course] = @Course, [CourseFee] = @CourseFee WHERE (([CourseID] = @Original_CourseID) AND ((@IsNull_Course = 1 AND [Course] IS NULL) OR ([Course] = @Original_Course)) AND ([CourseFee] = @Original_CourseFee));
SELECT CourseID, Course, CourseFee FROM Course WHERE (CourseID = @CourseID)";
        ...
        public virtual int Fill(TraineeDBDataSet1.CourseDataTable dataTable) {
        ...
        public virtual TraineeDBDataSet1.CourseDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TraineeDBDataSet1.CourseDataTable dataTable = new TraineeDBDataSet1.CourseDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TraineeDBDataSet1.CourseDataTable dataTable) {
        ...
        public virtual int Insert(int CourseID, string Course, int CourseFee) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((int)(CourseFee));
        ...
        public virtual int Update(int CourseID, string Course, int CourseFee, int Original_CourseID, string Original_Course, int Original_CourseFee) {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(CourseFee));
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_CourseFee));
        ...
        public virtual int Update(string Course, int CourseFee, int Original_CourseID, string Original_Course, int Original_CourseFee) {
            return this.Update(Original_CourseID, Course, CourseFee, Original_CourseID, Original_Course, Original_CourseFee);
        }
    }
